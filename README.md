...
```bash
http --verbose http://localhost:9000/api/v1/people
```
...
```bash
http --verbose POST http://localhost:9000/api/v1/people id=1 fullName="hello" lastName="world" email="world@world.com" birthDate="1995-11-25"
```
...
./bin/play-scala-project -Dplay.http.secret.key=some-long-key-that-will-be-used-by-your-application
```
...
```bash
./play-scala-project/target/gatling/gatlingspec-1472579540405/index.html
```
